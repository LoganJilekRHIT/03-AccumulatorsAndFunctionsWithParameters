...
def draw_circles1():
    ...
    for k in range(0, 200, 10):
        circle_guy = rg.Circle(rg.Point(200, 200), k)
...
def draw_circles2():
    ...
    this_window = rg.RoseWindow(400, 400)
    for k in range(50, 410, 20):
        circles = rg.Circle(rg.Point(k, 100), 10)
        circles.attach_to(this_window)
        circles.fill_color = 'blue'
        this_window.render(1/24)

    this_window.close_on_mouse_click()
...
def draw_circles3():
    ...
    that_window = rg.RoseWindow(300, 300)
    for k in range(1, 101):
        that_circles = rg.Circle(rg.Point(200, 150), k)
        that_circles.attach_to(that_window)
        that_window.render(1/24)

    that_window.close_on_mouse_click()
...
def draw_cosines_and_sines():
    ...
    final_window = rg.RoseWindow(400, 400)

    for k in range(0, 101):
        final_circle = rg.Circle(rg.Point(200 + (80 * m.cos(k)), 200 + (80 * m.sin(k))), 10)
        final_circle.attach_to(final_window)
        final_window.render(1/24)

    final_window.close_on_mouse_click()
